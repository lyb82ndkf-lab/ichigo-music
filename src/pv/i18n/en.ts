...
export const en: Record<LocaleKey, string> = {
  ...
  // Template names
  'tpl_cinemaTeal': 'Cinema Teal (video recommended)',
  'tpl_hakushi': 'White Paper',
  'tpl_yozakura': 'Night Sakura',
  'tpl_suisai': 'Watercolor',
  'tpl_cityPop': 'City Pop',
  'tpl_rainCity': 'Matrix',
  'tpl_neonNight': 'Neon Night',
  'tpl_mono': 'Mono (video recommended)',
  'tpl_tasogare': 'Dusk',
  'tpl_shinkuu': 'Deep Space',
  'tpl_zasshi': 'Magazine',
  'tpl_akaiito': 'Red Thread',
  'tpl_lemonSoda': 'Lemon Soda',
  'tpl_kiri': 'Fog',
  'tpl_shinpaku': 'Heartbeat',
