...
export const effectCatalog: EffectPreset[] = [
  ...
  // 日系MV Japanese MV
  { type: 'lyricText', label: '歌词文字 LyricText', category: '日系MV', layer: 'text', config: { color: '$text', fontSize: 58, fontFamily: '"Noto Serif JP", "Yu Mincho", "MS Mincho", serif', fontWeight: '500', letterSpacing: 8, y: 0.5, underline: { color: '$accent', thickness: 2, lengthFrac: 0.5, offsetFrac: 0.85, alpha: 0.8 } } },
  { type: 'meshGradient', label: '极光渐变 MeshGrad', category: '日系MV', layer: 'background', config: { colors: ['#232348', '#1a1a30', '#2c2242'], blend: 'add', count: 4, alpha: 0.5, speed: 0.7 } },
  { type: 'dustParticles', label: '浮尘散景 Dust', category: '日系MV', layer: 'decoration', config: { color: '#ffffff', count: 22, minSize: 3, maxSize: 12, alpha: 0.55, speed: 0.6, blend: 'add' } },
  { type: 'petalFall', label: '花瓣飘落 Petals', category: '日系MV', layer: 'decoration', config: { count: 15, colors: ['#ffd0dc', '#ffc0cf', '#ffe4ea'], minSize: 15, maxSize: 30, speed: 0.9, alpha: 0.95 } },
  { type: 'waveLines', label: '波浪层叠 Waves', category: '日系MV', layer: 'decoration', config: { color: '#7fd1d8', y: 0.78, spread: 0.1, layers: 3, amplitude: 16, speed: 0.3, alpha: 0.28 } },
  { type: 'speedLines', label: '集中线 SpeedLines', category: '日系MV', layer: 'decoration', config: { color: '#ffffff', count: 46, alpha: 0.2, rotSpeed: 0.04, lineWidth: 2, beatBoost: 0.08 } },
  { type: 'threadLine', label: '丝线 ThreadLine', category: '日系MV', layer: 'decoration', config: { color: '$accent', y: 0.58, amplitude: 0.14, speed: 0.35, width: 2, alpha: 0.85 } },
  { type: 'letterbox', label: '宽银幕黑边 Letterbox', category: '日系MV', layer: 'decoration', config: { color: '#000000', heightFrac: 0.1, alpha: 1 } },
  { type: 'starField', label: '星空 StarField', category: '日系MV', layer: 'decoration', config: { color: '#ffffff', count: 100, alpha: 0.8, constellations: true } },
  { type: 'retroSun', label: '复古落日 RetroSun', category: '日系MV', layer: 'decoration', config: { colorTop: '#ffd319', colorBottom: '#ff2975', x: 0.5, y: 0.56, sizeFrac: 0.62, beatPulse: 0.02 } },
