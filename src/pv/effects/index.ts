...
import { MatrixDecodeText } from './matrixDecodeText';
import { PixelTypewriterText } from './pixelTypewriterText';
import { ModernArchitectText } from './modernArchitectText';
import { PoeticStaggerText } from './poeticStaggerText';
import { PopComicText } from './popComicText';
import { CinematicCleanText } from './cinematicCleanText';
import { KineticSlashText } from './kineticSlashText';
import { P5StickerText } from './p5StickerText';
import { NeonFlickerText } from './neonFlickerText';
import { WatercolorSpreadText } from './watercolorSpreadText';
...
register('lyricText', LyricText);
register('meshGradient', MeshGradient);
register('dustParticles', DustParticles);
register('petalFall', PetalFall);
register('waveLines', WaveLines);
register('speedLines', SpeedLines);
register('threadLine', ThreadLine);
register('letterbox', Letterbox);
register('starField', StarField);
register('retroSun', RetroSun);

// Specialized Kinetic Word-Level Typography Renderers
register('matrixDecodeText', MatrixDecodeText);
register('pixelTypewriterText', PixelTypewriterText);
register('modernArchitectText', ModernArchitectText);
register('poeticStaggerText', PoeticStaggerText);
register('popComicText', PopComicText);
register('cinematicCleanText', CinematicCleanText);
register('kineticSlashText', KineticSlashText);
register('p5StickerText', P5StickerText);
register('neonFlickerText', NeonFlickerText);

register('watercolorSpreadText', WatercolorSpreadText);
