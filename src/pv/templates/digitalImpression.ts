// PV Tool ‚Ä?Copyright (c) 2026 DanteAlighieri13210914
...
export const digitalImpressionTemplate: TemplateConfig = {
  ...
  effects: [
    ...
    // Large paint smear / scrape strokes ‚Ä?the core visual identity
    ...
    // Overexposed glow ‚Ä?bright area bleeding through
    ...
    // Glitch bars ‚Ä?pixel block displacement on the right side
    { type: 'glitchBars', layer: 'overlay', config: {
      color: '#00ffcc', alpha: 0.5,
    }},

    // Chromatic aberration ‚Ä?RGB channel separation
    ...
    // Scattered shapes ‚Ä?abstract geometric city silhouettes
