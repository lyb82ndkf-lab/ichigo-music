...
- **全景沉浸模式**：提供 7 款各具特色的全屏动效舞台，从动感逐字、空间画布到 KTV 与 PV 艺术排版。
...
点击播放栏封面或全屏按钮即可进入沉浸模式。系统支持专辑主色提取、动态光影模糊、多种视觉粒子及丰富的排版动画。

#### 沉浸模式 1：动感逐字与柔和渐变
跟随音乐节拍逐字平滑过渡，配合基于专辑封面色调生成的呼吸光影。

![沉浸模式 1](./picture/沉浸模式1.png)

#### 沉浸模式 2：动态光晕与大字排版
居中大字号排版，聚焦歌词意境，光晕随旋律起伏扩散。

![沉浸模式 2](./picture/沉浸模式2.png)

#### 沉浸模式 3：空间画布与悬浮胶囊
轻量胶囊高亮包裹当前唱段，营造空间景深虚化层次。

![沉浸模式 3](./picture/沉浸模式3.png)

#### 沉浸模式 4：多彩气泡聚光流
将歌词与旋律化作轻盈的气泡流，层次分明，观赏性极佳。

![沉浸模式 4](./picture/沉浸模式4.png)

#### 沉浸模式 5：云阶层叠与深度透视
立体的云阶层级动效，上下滚动如行云流水般平顺。

![沉浸模式 5](./picture/沉浸模式5.png)

#### 沉浸模式 6：KTV 动感卡拉OK 与动效扫字
精准契合音节节奏的卡拉OK动态扫光效果，还原现场视听氛围。

![沉浸模式 6](./picture/沉浸模式6.png)

#### 沉浸模式 7：PV 动态视觉与艺术排版
结合艺术字排版、动态镜头拉伸与背景氛围渲染，呈现 MV 级的观感。

![沉浸模式 7](./picture/沉浸模式7.png)
